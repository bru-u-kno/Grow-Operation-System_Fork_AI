...
const META: Record<string, { ziel: UebergabeZiel; name: string; zusatz?: string; einheit: string }> = {
  ...
  'luft-unten': { ziel: 'grenzwerte', name: 'Lufttemperatur unten', zusatz: 'Tag', einheit: '°C' },
  'luft-oben': { ziel: 'grenzwerte', name: 'Lufttemperatur oben', zusatz: 'Tag', einheit: '°C' },
  'luft-nacht-unten': { ziel: 'grenzwerte', name: 'Lufttemperatur unten', zusatz: 'Nacht', einheit: '°C' },
  'luft-nacht-oben': { ziel: 'grenzwerte', name: 'Lufttemperatur oben', zusatz: 'Nacht', einheit: '°C' },
